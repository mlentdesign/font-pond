...
const KEYWORD_WANT: Record<string, string[]> = {
  ...
  "pool party": ["fun", "bold", "modern", "vibrant", "display", "friendly"],
  ...
  // ═══════════════════════════════════════════════
  mediterranean: ["warm", "organic", "earthy", "serif", "elegant", "rustic"],
  tuscan: ["warm", "earthy", "organic", "serif", "rustic", "vintage"],
  provencal: ["warm", "elegant", "feminine", "organic", "serif", "romantic"],
  parisian: ["elegant", "refined", "serif", "feminine", "modern", "luxury"],
  ...
  wabi: ["minimal", "organic", "imperfect", "warm", "zen", "earthy"],
  "wabi sabi": ["minimal", "organic", "imperfect", "warm", "earthy", "handwritten"],
  kinfolk: ["minimal", "editorial", "warm", "organic", "clean", "modern"],
  hygge: ["warm", "soft", "organic", "friendly", "cozy", "minimal"],
  lagom: ["minimal", "clean", "balanced", "modern", "scandinavian", "friendly"],
  ...
  // ═══════════════════════════════════════════════
  "light academia": ["literary", "classic", "serif", "warm", "elegant", "cream", "soft"],
  "new money": ["bold", "modern", "luxury", "display", "flashy", "vibrant"],
  "quiet luxury": ["minimal", "clean", "elegant", "serif", "refined", "restrained"],
  "mob wife": ["bold", "luxury", "dramatic", "ornate", "serif", "dark"],
  "coastal grandmother": ["soft", "warm", "organic", "clean", "serif", "elegant"],
  "coastal cowgirl": ["warm", "western", "organic", "feminine", "bold", "fun"],
  "vanilla girl": ["soft", "minimal", "clean", "cream", "feminine", "gentle"],
  coquette: ["feminine", "delicate", "romantic", "script", "soft", "pink"],
  balletcore: ["feminine", "delicate", "elegant", "soft", "light", "flowing"],
  tomato: ["bold", "warm", "vibrant", "fun", "modern", "friendly"],
  "tomato girl": ["warm", "vibrant", "organic", "bold", "fun", "mediterranean"],
  barbiecore: ["bold", "pink", "fun", "girly", "pop", "vibrant"],
  "that girl": ["clean", "modern", "minimal", "feminine", "friendly", "rounded"],
  "it girl": ["bold", "modern", "fashion", "editorial", "elegant", "display"],
  normcore: ["clean", "minimal", "neutral", "modern", "friendly", "simple"],
  gorpcore: ["bold", "modern", "outdoor", "earthy", "dynamic", "condensed"],
  blokette: ["feminine", "sporty", "modern", "bold", "fun", "friendly"],
  "quiet storm": ["elegant", "dark", "moody", "serif", "minimal", "cool"],
  "dark romance": ["dark", "gothic", "romantic", "serif", "ornate", "moody"],
  "dark romantic": ["dark", "gothic", "romantic", "serif", "ornate", "moody"],
  ...
  "pastel goth": ["pastel", "gothic", "soft", "dark", "feminine", "alternative"],
  "nu goth": ["gothic", "modern", "dark", "minimal", "edgy", "bold"],
  "health goth": ["dark", "modern", "bold", "sporty", "geometric", "edgy"],
  "romantic goth": ["gothic", "ornate", "romantic", "dark", "serif", "flowing"],
  kidcore: ["fun", "bold", "playful", "bright", "rounded", "retro"],
  weirdcore: ["experimental", "distorted", "surreal", "glitch", "edgy", "quirky"],
  dreamcore: ["soft", "surreal", "light", "dreamy", "pastel", "feminine"],
  traumacore: ["raw", "distressed", "dark", "edgy", "experimental", "grunge"],
  ...
  cluttercore: ["eclectic", "bold", "vibrant", "fun", "maximalist", "vintage"],
  maximalist: ["bold", "ornate", "vibrant", "dramatic", "decorative", "display"],
  japandi: ["minimal", "warm", "organic", "japanese", "scandinavian", "clean"],
  wabisabi: ["organic", "minimal", "imperfect", "warm", "earthy", "handwritten"],
  biophilic: ["organic", "natural", "warm", "green", "modern", "friendly"],
  lunarpunk: ["dark", "mystical", "organic", "modern", "gothic", "flowing"],
  dieselpunk: ["vintage", "industrial", "bold", "heavy", "retro", "dark"],
  atompunk: ["retro", "bold", "futuristic", "vintage", "geometric", "display"],
  clockpunk: ["vintage", "ornate", "mechanical", "serif", "steampunk", "decorative"],
  biopunk: ["organic", "dark", "modern", "edgy", "tech", "green"],
  cassettepunk: ["retro", "vintage", "80s", "fun", "bold", "nostalgic"],
  "lo fi": ["warm", "vintage", "handwritten", "organic", "soft", "retro"],
  ...
  // ═══════════════════════════════════════════════
  "mid century modern": ["retro", "vintage", "modern", "clean", "geometric", "warm"],
  ...
  edwardian: ["elegant", "serif", "refined", "traditional", "ornate", "classic"],
  ...
  "fairy tale": ["whimsical", "script", "ornate", "feminine", "flowing", "fantasy"],
  ...
  lightning: ["bold", "sharp", "dynamic", "angular", "display", "electric"],
  ...
  rococo: ["ornate", "decorative", "elegant", "feminine", "flowing", "luxury"],
